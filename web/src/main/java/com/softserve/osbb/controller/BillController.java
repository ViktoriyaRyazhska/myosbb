...
public class BillController {
	...
	public ResponseEntity<PageDataObject<Resource<BillDTO>>> findAllBills(@RequestParam(value = "status", required = false) String status, @RequestBody PageParams pageParams) {
	...
	public ResponseEntity<PageDataObject<Resource<BillDTO>>> listAllBillsByUser(@PathVariable("userId") Integer userId, @RequestParam(value = "status", required = false) String status, @RequestBody PageParams pageParams) {
	...
	private PageRequest buildPageRequest(PageParams pageParams) {
		final PageRequest pageRequest = PageRequestGenerator.generatePageRequest(pageParams.getPageNumber()).addRows(pageParams.getRowNum()).addOrderType(pageParams.getOrderType()).addSortedBy(pageParams.getSortedBy(), "date").toPageRequest();
		return pageRequest;
	}
