    ...
    public void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
            .authorizeRequests()
                ...
                .antMatchers("/restful/provider/**").permitAll()
                .antMatchers("/restful/providertype/**").permitAll()
                .antMatchers("/restful/address/street**").permitAll()
                .antMatchers("/restful/address/street/**").permitAll()
                .antMatchers("/restful/address/district**").permitAll()
                .antMatchers("/restful/address/district/**").permitAll()
                .antMatchers("/restful/address/region**").permitAll()
                .antMatchers("/restful/address/region/**").permitAll()
                ...
                .antMatchers("/restful/google-drive/**").permitAll()
