...
public class AddressServiceImpl implements AddressService {
	...
	public Region updateRegion(Region region) {
		if (regionRepository.exists(region.getId())) {
			...
			throw new IllegalArgumentException(
					"Region with id=" + region.getId() + " doesn't exist. First try to add this region.");
		}
	}
	...
	public boolean deleteRegion(Integer id) {
		if (getAllCitiesOfRegion(id).isEmpty()) {
			...
			throw new IllegalArgumentException(
					"Cities of region with id=" + id + " exist. First they should be deleted.");
		}
	}
	...
	public City updateCity(City city) {
		if (cityRepository.exists(city.getId())) {
			...
			throw new IllegalArgumentException(
					"City with id=" + city.getId() + " doesn't exist. First try to add this city.");
		}
	}
	...
	public boolean deleteCity(Integer id) {
		if (getAllStreetsOfCity(id).isEmpty() || getAllDistrictsOfCity(id).isEmpty()) {
			...
			throw new IllegalArgumentException(
					"Cities or districts of region with id=" + id + " exist. First they should be deleted.");
		}
	}
	...
	public Street updateStreet(Street street) {
		if (streetRepository.exists(street.getId())) {
			...
			throw new IllegalArgumentException(
					"Street with id=" + street.getId() + " doesn't exist. First try to add this city.");
		}
	}
	...
	public boolean deleteStreet(Integer id) {
		if (osbbRepository.findByStreetId(id).isEmpty()) {
			...
			throw new IllegalArgumentException(
					"Objects, used street with id=" + id + " exist. First they should be deleted.");
		}
	}
	...
	public District updateDistrict(District district) {
		if (districtRepository.exists(district.getId())) {
			...
			throw new IllegalArgumentException(
					"District with id=" + district.getId() + " doesn't exist. First try to add this district.");
		}
	}
	...
	public boolean deleteDistrict(Integer id) {
		if (osbbRepository.findByDistrictId(id).isEmpty()) {
			...
			throw new IllegalArgumentException(
					"Objects, used district with id=" + id + " exist. First they should be deleted.");
		}
	}
}
